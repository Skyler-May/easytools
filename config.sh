...
DOCKER_MENU_SCRIPT_PATH="$SCRIPT_DIR/docker/docker_menu.sh"
...
UNINSTALL_DOCKER_SCRIPT_PATH="$SCRIPT_DIR/docker/uninstall_docker.sh"
...
# echo "DOCKER_MENU_SCRIPT_PATH: $DOCKER_MENU_SCRIPT_PATH"
...
# echo "UNINSTALL_DOCKER_SCRIPT_PATH: $UNINSTALL_DOCKER_SCRIPT_PATH"
