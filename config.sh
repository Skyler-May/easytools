...
RESTART_CONTAINER_SCRIPT_PATH="$SCRIPT_DIR/docker-lnmp/ubuntu-debian/arm64/restart_container.sh"
...
STEP2_INSTALL_DOCKER_LNMP_SCRIPT_PATH="$SCRIPT_DIR/website/sspanel/ubuntu/step2_install_docker_lnmp.sh"
STEP3_NGINX_SCRIPT_PATH="$SCRIPT_DIR/website/sspanel/ubuntu/step3_nginx.conf.sh"
STEP4_INSTALL_SSPANEL_SCRIPT_PATH="$SCRIPT_DIR/website/sspanel/ubuntu/step4_install_sspanel.sh"
...
# echo "STEP2_INSTALL_DOCKER_LNMP_SCRIPT_PATH: $STEP2_INSTALL_DOCKER_LNMP_SCRIPT_PATH"
# echo "STEP3_NGINX_SCRIPT_PATH: $STEP3_NGINX_SCRIPT_PATH"
# echo "STEP4_INSTALL_SSPANEL_SCRIPT_PATH: $STEP4_INSTALL_SSPANEL_SCRIPT_PATH"
